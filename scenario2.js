...
if (reversed == null) { reversed = false; }
	...
	this.text.parent = this;
	this.text.setTransform(-6.1,-103.55);
...
p.nominalBounds = new cjs.Rectangle(-508,-105.5,1003.9,265.1);
...
p.nominalBounds = new cjs.Rectangle(-364.9,-75,793.9,221.3);
...
if (reversed == null) { reversed = false; }
	...
	this.text.parent = this;
	this.text.setTransform(25.5,-73);
...
p.nominalBounds = new cjs.Rectangle(-364.9,-75,780.9,172);
...
(lib.BackButton10 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.text = new cjs.Text("BACK", "49px 'Arial'", "#FFFFFF");
	this.text.lineHeight = 57;
	this.text.lineWidth = 169;
	this.text.parent = this;
	this.text.setTransform(-146.95,-47.45);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AwKGQIAAsfMAgVAAAIAAMfg");
	this.shape.setTransform(-79.475,-17.95);
...
p.nominalBounds = new cjs.Rectangle(-182.9,-57.9,206.9,105);


(lib.BackButton9 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.BackButton8 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.BackButton7 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.BackButton6 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.BackButton1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-462,-126.4,1003.9,280.1);
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0,2,354,1404,1743,2668,3753,3754,3960,4274,4553,4751,4964,5175,5369,5594,5915,6424,6441,6564,6742,7023,7773,8368,8523,8961];
	this.streamSoundSymbolsList[2] = [{id:"WarmMemoriesEmotionalInspiringPiano",startFrame:2,endFrame:3754,loop:1,offset:0}];
	this.streamSoundSymbolsList[6441] = [{id:"WarmMemoriesEmotionalInspiringPiano",startFrame:6441,endFrame:8961,loop:1,offset:268656}];
	// timeline functions:
	...
	this.frame_2 = function() {
		var soundInstance = playSound("WarmMemoriesEmotionalInspiringPiano",0);
	...
	this.frame_1743 = function() {
		...
		_this.gotoAndPlay(1405);
		});
	}
	this.frame_2668 = function() {
		var _this = this;
		
		_this.BackButton4.on('click', function(){
		
		_this.gotoAndPlay(1744);
		});
	}
	...
	this.frame_6441 = function() {
		var soundInstance = playSound("WarmMemoriesEmotionalInspiringPiano",0,268656);
		this.InsertIntoSoundStreamData(soundInstance,6441,8961,1,268656);
	}
	this.frame_6564 = function() {
		var _this = this;
		
		_this.BackButton5.on('click', function(){
		
		_this.gotoAndPlay(6442);
		});
	}
	this.frame_6742 = function() {
		var _this = this;
		
		_this.BackButton6.on('click', function(){
		
		_this.gotoAndPlay(6565);
		});
	}
	this.frame_7023 = function() {
		var _this = this;
		
		_this.BackButton7.on('click', function(){
		
		_this.gotoAndPlay(6743);
		});
	}
	this.frame_7773 = function() {
		var _this = this;
		
		_this.BackButton8.on('click', function(){
		
		_this.gotoAndPlay(7024);
		});
	}
	this.frame_8368 = function() {
		var _this = this;
		
		_this.BackButton9.on('click', function(){
		
		_this.gotoAndPlay(7774);
		});
	}
	this.frame_8523 = function() {
		var _this = this;
		
		_this.BackButton10.on('click', function(){
		
		_this.gotoAndPlay(8369);
		});
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(2).call(this.frame_2).wait(352).call(this.frame_354).wait(1050).call(this.frame_1404).wait(339).call(this.frame_1743).wait(925).call(this.frame_2668).wait(1085).call(this.frame_3753).wait(1).call(this.frame_3754).wait(206).call(this.frame_3960).wait(314).call(this.frame_4274).wait(279).call(this.frame_4553).wait(198).call(this.frame_4751).wait(213).call(this.frame_4964).wait(211).call(this.frame_5175).wait(194).call(this.frame_5369).wait(225).call(this.frame_5594).wait(321).call(this.frame_5915).wait(509).call(this.frame_6424).wait(17).call(this.frame_6441).wait(123).call(this.frame_6564).wait(178).call(this.frame_6742).wait(281).call(this.frame_7023).wait(750).call(this.frame_7773).wait(595).call(this.frame_8368).wait(155).call(this.frame_8523).wait(438).call(this.frame_8961).wait(1));

	// BackButton1
	this.BackButton1 = new lib.BackButton1();
	this.BackButton1.name = "BackButton1";
	this.BackButton1.setTransform(149.75,720.95,0.65,0.65);
	this.BackButton1._off = true;
	new cjs.ButtonHelper(this.BackButton1, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton1).wait(354).to({_off:false},0).to({_off:true},1050).wait(7558));

	// BackButton2
	this.Backbutton2 = new lib.BackButton2();
	this.Backbutton2.name = "Backbutton2";
	this.Backbutton2.setTransform(149.8,720.95,0.65,0.65,0,0,0,0.1,0);
	this.Backbutton2._off = true;
	new cjs.ButtonHelper(this.Backbutton2, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.Backbutton2).wait(1404).to({_off:false},0).to({_off:true},339).wait(7219));

	// BackButton3
	this.BackButton3 = new lib.BackButton3();
	this.BackButton3.name = "BackButton3";
	this.BackButton3.setTransform(149.8,720.95,0.65,0.65,0,0,0,0.1,0);
	this.BackButton3._off = true;
	new cjs.ButtonHelper(this.BackButton3, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton3).wait(1743).to({_off:false},0).to({_off:true},925).wait(6294));

	// BackButton4
	this.BackButton4 = new lib.BackButton4();
	this.BackButton4.name = "BackButton4";
	this.BackButton4.setTransform(970.5,721,0.65,0.65,0,0,0,0,0.1);
	this.BackButton4._off = true;
	new cjs.ButtonHelper(this.BackButton4, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton4).wait(2668).to({_off:false},0).to({_off:true},1086).wait(5208));

	// BackButton5
	this.BackButton5 = new lib.BackButton5();
	this.BackButton5.name = "BackButton5";
	this.BackButton5.setTransform(149.75,720.95,0.65,0.65);
	this.BackButton5._off = true;
	new cjs.ButtonHelper(this.BackButton5, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton5).wait(6564).to({_off:false},0).to({_off:true},178).wait(2220));

	// BackButton6
	this.BackButton6 = new lib.BackButton6();
	this.BackButton6.name = "BackButton6";
	this.BackButton6.setTransform(149.75,720.95,0.65,0.65,0,0,0,0.1,0);
	this.BackButton6._off = true;
	new cjs.ButtonHelper(this.BackButton6, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton6).wait(6742).to({_off:false},0).to({_off:true},281).wait(1939));

	// BackButton7
	this.BackButton7 = new lib.BackButton7();
	this.BackButton7.name = "BackButton7";
	this.BackButton7.setTransform(149.75,721,0.65,0.65,0,0,0,0,0.1);
	this.BackButton7._off = true;
	new cjs.ButtonHelper(this.BackButton7, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton7).wait(7023).to({_off:false},0).to({_off:true},750).wait(1189));

	// BackButton8
	this.BackButton8 = new lib.BackButton8();
	this.BackButton8.name = "BackButton8";
	this.BackButton8.setTransform(149.8,721,0.65,0.65,0,0,0,0.1,0.1);
	this.BackButton8._off = true;
	new cjs.ButtonHelper(this.BackButton8, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton8).wait(7773).to({_off:false},0).to({_off:true},595).wait(594));

	// BackButton9
	this.BackButton9 = new lib.BackButton9();
	this.BackButton9.name = "BackButton9";
	this.BackButton9.setTransform(149.75,721,0.65,0.65,0,0,0,0,0.1);
	this.BackButton9._off = true;
	new cjs.ButtonHelper(this.BackButton9, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton9).wait(8368).to({_off:false},0).to({_off:true},155).wait(439));

	// BackButton10
	this.BackButton10 = new lib.BackButton10();
	this.BackButton10.name = "BackButton10";
	this.BackButton10.setTransform(149.8,720.95,0.65,0.65,0,0,0,0.1,0);
	this.BackButton10._off = true;
	new cjs.ButtonHelper(this.BackButton10, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton10).wait(8523).to({_off:false},0).wait(439));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"sounds/WarmMemoriesEmotionalInspiringPiano.mp3", id:"WarmMemoriesEmotionalInspiringPiano"}
	],
	preloads: []
};
