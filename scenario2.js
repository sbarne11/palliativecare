...
lib.ssMetadata = [
		{name:"scenario2_atlas_1", frames: [[0,0,1046,774],[0,776,1027,768],[1215,1478,369,195],[1048,586,163,608],[1564,986,172,490],[1821,586,173,490],[1738,1078,206,384],[457,1546,377,490],[836,1546,377,490],[0,1546,455,455],[1048,0,964,584],[1582,586,237,398],[1215,870,347,249],[1215,586,365,282],[1029,1196,360,221]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("Patients should be given appropriate information about their pain, and pain management, and be encouraged to participate  in their treatment plan.", "bold 35px 'Leelawadee'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	this.text.parent = this;
	this.text.setTransform(0,-130.55);
...
p.nominalBounds = new cjs.Rectangle(-381.9,-132.5,763.9,265.1);
...
p.nominalBounds = new cjs.Rectangle(-389.9,-132.5,779.9,265.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("He is in for protective isolation with low white blood cells count", "bold 30px 'Leelawadee'");
	this.text.lineHeight = 38;
	this.text.lineWidth = 578;
	this.text.parent = this;
	this.text.setTransform(-289.05,-55.75);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-184.5,-97.5);
...
p.nominalBounds = new cjs.Rectangle(-184.5,-97.5,369,195);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("He has a grade 4 mucositis and his blood report reveals a neutrophil count of 0.5\nHe has a pyrexia of 38.5℃", "bold 44px 'Leelawadee'");
	this.text.textAlign = "center";
	this.text.lineHeight = 55;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("He was diagnosed with Stage 1A Non-Small Cell Lung Cancer two months ago. ", "bold 44px 'Leelawadee'");
	this.text.textAlign = "center";
	this.text.lineHeight = 55;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("John has arrived to the ward. \n\nBrian notes:\n", "bold 44px 'Leelawadee'");
	this.text.lineHeight = 55;
	this.text.lineWidth = 907;
	this.text.parent = this;
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(46,-5.9);
	this.instance_1._off = true;

	this.instance_2 = new lib.Tween81("synched",0);
	this.instance_2.setTransform(46,-5.9);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween82("synched",0);
	this.instance_3.setTransform(46,-5.9);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},21).to({state:[{t:this.instance_2}]},109).to({state:[{t:this.instance_3}]},24).to({state:[]},1).wait(213));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,alpha:1},21).wait(347));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},21).to({_off:true},109).wait(238));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({_off:false},109).to({_off:true,alpha:0},24).wait(214));
	...
	this.instance_5 = new lib.Tween84("synched",0);
	this.instance_5.setTransform(29.5,-32.7);
	this.instance_5._off = true;

	this.instance_6 = new lib.Tween85("synched",0);
	this.instance_6.setTransform(29.5,-32.7);
	this.instance_6._off = true;

	this.instance_7 = new lib.Tween86("synched",0);
	this.instance_7.setTransform(29.5,-32.7);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},154).to({state:[{t:this.instance_5}]},18).to({state:[{t:this.instance_6}]},66).to({state:[{t:this.instance_7}]},17).to({state:[]},1).wait(112));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(154).to({_off:false},0).to({_off:true,alpha:1},18).wait(196));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(154).to({_off:false},18).to({_off:true},66).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(172).to({_off:false},66).to({_off:true,alpha:0},17).wait(113));

	// L3
	this.instance_8 = new lib.Tween87("synched",0);
	this.instance_8.setTransform(60,-31.75);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.instance_9 = new lib.Tween88("synched",0);
	this.instance_9.setTransform(60,-31.75);
	this.instance_9._off = true;

	this.instance_10 = new lib.Tween89("synched",0);
	this.instance_10.setTransform(60,-31.75);
	this.instance_10._off = true;

	this.instance_11 = new lib.Tween90("synched",0);
	this.instance_11.setTransform(60,-31.75);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8}]},255).to({state:[{t:this.instance_9}]},17).to({state:[{t:this.instance_10}]},77).to({state:[{t:this.instance_11}]},18).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(255).to({_off:false},0).to({_off:true,alpha:1},17).wait(96));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(255).to({_off:false},17).to({_off:true},77).wait(19));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(272).to({_off:false},77).to({_off:true,alpha:0},18).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-335.9,-138.4,763.9,265.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance_4 = new lib.Tween75("synched",0);
	this.instance_4.setTransform(21,-25.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.instance_5 = new lib.Tween76("synched",0);
	this.instance_5.setTransform(21,-25.9);
	this.instance_5._off = true;

	this.instance_6 = new lib.Tween77("synched",0);
	this.instance_6.setTransform(21,-25.9);
	this.instance_6._off = true;

	this.instance_7 = new lib.Tween78("synched",0);
	this.instance_7.setTransform(21,-25.9);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},121).to({state:[{t:this.instance_5}]},18).to({state:[{t:this.instance_6}]},122).to({state:[{t:this.instance_7}]},20).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(121).to({_off:false},0).to({_off:true,alpha:1},18).wait(143));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(121).to({_off:false},18).to({_off:true},122).wait(21));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(139).to({_off:false},122).to({_off:true,alpha:0},20).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-368.9,-158.4,797.9,285.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-10.45,17.25);
	this.instance.alpha = 0;

	this.instance_1 = new lib.Tween103("synched",0);
	this.instance_1.setTransform(-10.45,17.25);
	this.instance_1._off = true;

	this.instance_2 = new lib.Tween104("synched",0);
	this.instance_2.setTransform(-10.45,17.25);
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween105("synched",0);
	this.instance_3.setTransform(-10.45,17.25);
	this.instance_3.alpha = 0;
...
p.nominalBounds = new cjs.Rectangle(-516.9,-71.4,1012.9,177.4);
...
if (reversed == null) { reversed = false; }
	...
	// Diagram
	this.instance_58 = new lib.Tween15("synched",0);
	this.instance_58.setTransform(205.5,551.5);
	this.instance_58.alpha = 0;
	this.instance_58._off = true;

	this.instance_59 = new lib.Tween16("synched",0);
	this.instance_59.setTransform(205.5,551.5);
	this.instance_59._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_58).wait(3146).to({_off:false},0).to({_off:true,alpha:1},14).wait(5802));
	this.timeline.addTween(cjs.Tween.get(this.instance_59).wait(3146).to({_off:false},14).to({startPosition:0},83).to({alpha:0},16).to({_off:true},1).wait(5702));

	// Text3
	this.instance_60 = new lib.Text3("synched",0);
	this.instance_60.setTransform(542.35,657.85,1,1,0,0,0,-133.5,-42.2);
	this.instance_60.alpha = 0;
	this.instance_60._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_60).wait(3259).to({_off:false},0).to({alpha:1},14).to({startPosition:0},158).to({alpha:0},15).to({_off:true},1).wait(5515));

	// Text4
	this.instance_61 = new lib.Text4("synched",0);
	this.instance_61.setTransform(559.25,670.1,1,1,0,0,0,1,-20.9);
	this.instance_61.alpha = 0;
	this.instance_61._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_61).wait(3431).to({_off:false},0).to({alpha:1},15).to({startPosition:0},185).to({alpha:0},15).to({_off:true},1).wait(5315));

	// SpeechBubble1
	this.instance_62 = new lib.SpeechB3("synched",0);
	this.instance_62.setTransform(508.95,181.7,1,1,0,0,0,-5.5,5.5);
	this.instance_62.alpha = 0;
	this.instance_62._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_62).wait(3646).to({_off:false},0).to({alpha:1},16).to({startPosition:0},77).to({alpha:0},14).to({_off:true},1).wait(5208));

	// Patient
	this.instance_63 = new lib.Tween10("synched",0);
	this.instance_63.setTransform(397.25,483.85);
	this.instance_63.alpha = 0;
	this.instance_63._off = true;

	this.instance_64 = new lib.Tween11("synched",0);
	this.instance_64.setTransform(397.25,483.85);
	this.instance_64._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_63).wait(3100).to({_off:false},0).to({_off:true,alpha:1},16).wait(5846));
	this.timeline.addTween(cjs.Tween.get(this.instance_64).wait(3100).to({_off:false},16).to({startPosition:0},3308).to({alpha:0},17).to({_off:true},1).wait(2520));

	// Text2
	this.instance_65 = new lib.Text2("synched",0);
	this.instance_65.setTransform(535.85,115.9,1,1,0,0,0,-22,-76);
	this.instance_65.alpha = 0;
	this.instance_65._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_65).wait(3116).to({_off:false},0).to({alpha:1},17).to({startPosition:0},498).to({alpha:0},15).to({_off:true},1).wait(5315));

	// NurseSitting
	this.instance_66 = new lib.Tween12("synched",0);
	this.instance_66.setTransform(672.55,485.45);
	this.instance_66.alpha = 0;
	this.instance_66._off = true;

	this.instance_67 = new lib.Tween13("synched",0);
	this.instance_67.setTransform(672.55,485.45);
	this.instance_67._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_66).wait(3100).to({_off:false},0).to({_off:true,alpha:1},16).wait(5846));
	this.timeline.addTween(cjs.Tween.get(this.instance_67).wait(3100).to({_off:false},16).to({startPosition:0},639).to({startPosition:0},2669).to({alpha:0},17).to({_off:true},1).wait(2520));

	// TextReflect1
	this.instance_68 = new lib.TextReflect1("synched",0);
	this.instance_68.setTransform(529.85,106.35,1,1,0,0,0,25.5,-8);
	this.instance_68.alpha = 0;
	this.instance_68._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_68).wait(6441).to({_off:false},0).to({alpha:1},16).to({startPosition:0},79).to({alpha:0},13).to({_off:true},1).wait(2412));

	// TextReflect2_copy
	this.instance_69 = new lib.TextReflect2("synched",0);
	this.instance_69.setTransform(525.8,130.4,1,1,0,0,0,32,16.7);
	this.instance_69._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_69).wait(6561).to({_off:false},0).to({startPosition:0},12).to({startPosition:0},154).to({alpha:0},15).to({_off:true},1).wait(2219));

	// Textreflect3
	this.instance_70 = new lib.TextReflect3("synched",0);
	this.instance_70.setTransform(530.55,141.35,1,1,0,0,0,30,-15.6);
	this.instance_70._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_70).wait(6742).to({_off:false},0).wait(281).to({y:98.3,startPosition:281},0).to({_off:true},1).wait(1938));

	// TextReflect4
	this.instance_71 = new lib.TextReflect4("synched",0);
	this.instance_71.setTransform(520.4,146.85,1,1,0,0,0,46,-5.9);
	this.instance_71._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_71).wait(7023).to({_off:false},0).to({_off:true},369).wait(1570));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_72).wait(6499).to({_off:false},0).to({alpha:1},13).to({startPosition:0},880).to({alpha:0},26).to({_off:true},1).wait(1543));

	// NusreStanding1
	this.instance_73 = new lib.Tween17("synched",0);
	this.instance_73.setTransform(631.5,463);
	this.instance_73.alpha = 0;
	this.instance_73._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_73).wait(6441).to({_off:false},0).to({alpha:1},16).to({startPosition:0},961).to({alpha:0},19).to({_off:true},1).wait(1524));

	// SBPerceptor
	this.instance_74 = new lib.SpeechPreceptor("synched",0);
	this.instance_74.setTransform(480.85,161.25,1,1,0,0,0,-7.9,-17.2);
	this.instance_74._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_74).wait(7437).to({_off:false},0).to({_off:true},337).wait(1188));

	// Layer_5
	this.instance_75 = new lib.pain("synched",0);
	this.instance_75.setTransform(526.3,659.9,1,1,0,0,0,-10.5,17.2);
	this.instance_75._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_75).wait(7774).to({_off:false},0).to({_off:true},203).wait(985));

	// Layer_6
	this.instance_76 = new lib.Analgesia("synched",0);
	this.instance_76.setTransform(580.95,258.25,1,1,0,0,0,-17.9,126.8);
	this.instance_76._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_76).wait(7977).to({_off:false},0).to({_off:true},393).wait(592));

	// Layer_7
	this.instance_77 = new lib.PainTogether("synched",0);
	this.instance_77.setTransform(514.4,75.05,1,1,0,0,0,20,-152.8);
	this.instance_77._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_77).wait(8370).to({_off:false},0).wait(502).to({startPosition:0},0).to({_off:true},1).wait(89));

	// Nurse2
	this.instance_78 = new lib.Tween92("synched",0);
	this.instance_78.setTransform(672.6,485.55,1.19,1.19,0,0,0,0.1,0.1);
	this.instance_78.alpha = 0;
	this.instance_78._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_78).wait(7418).to({_off:false},0).to({alpha:1},19).to({scaleY:1.1899},1422).to({scaleY:1.19,alpha:0},13).to({_off:true},1).wait(89));

	// Patient1
	this.instance_79 = new lib.Tween91("synched",0);
	this.instance_79.setTransform(397.35,485.55,1.0342,1.148,0,0,0,0.1,0.1);
	this.instance_79.alpha = 0;
	this.instance_79._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_79).wait(7418).to({_off:false},0).to({alpha:1},19).to({scaleX:1.0341,scaleY:1.1479},1422).to({scaleX:1.0342,alpha:0},13).to({_off:true},1).wait(89));

	// Layer_1
	this.instance_80 = new lib.BrianDiscuss("synched",0);
	this.instance_80.setTransform(530.8,123.05,1,1,0,0,0,68,-119.8);
	this.instance_80.alpha = 0;
	this.instance_80._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_80).wait(8872).to({_off:false},0).to({alpha:1},17).to({startPosition:0},72).wait(1));

	// Layer_8
	this.instance_81 = new lib.Layer8("synched",0);
	this.instance_81.setTransform(513.5,384,1,1,0,0,0,93.5,-74);
	this.instance_81.alpha = 0;
	this.instance_81._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_81).wait(8859).to({_off:false},0).to({alpha:1},13).to({startPosition:0},89).wait(1));

	// Background1
	this.instance_82 = new lib.Tween5("synched",0);
	this.instance_82.setTransform(524,390.5);
	this.instance_82._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_82).wait(2015).to({_off:false},0).to({startPosition:0},1739).to({startPosition:0},2687).to({startPosition:0},2418).to({alpha:0},13).to({_off:true},1).wait(89));
