...
p.nominalBounds = new cjs.Rectangle(-377.4,-26.5,754.8,53.1);
...
if (reversed == null) { reversed = false; }
	...
	this.text.parent = this;
	this.text.setTransform(0,-77.25);
...
p.nominalBounds = new cjs.Rectangle(-431.7,-79.2,863.5,158.5);
