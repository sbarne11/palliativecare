...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•She would like to carry out last offices when Karen dies, as delivering nursing care for Karen for the final time would be a privilege ", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•That Jane feels safe in terms of expressing how she is dealing with a death of a patient for the first time", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•That Karen is comfortable and her family are supported", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Having her family around her. Her son is home from Australia", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 687;
	this.text.parent = this;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Her friends: FaceTime and phoned", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 582;
	this.text.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-293.1,-28.2,586.3,56.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Pictures of her garden ", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•That she is safe in the care of the staff on the ward", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Consider the patient and family as a unity in delivering care", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Allow family involvement in the care delivery, with Karen’s consent, and if they so wish", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Be sensitive to the spiritual needs of Karen, creating an environment in which she feels safe", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Ensure privacy is provided for Karen and her family as much as possible", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("Monitor and record bowel pattern; record of last bowel movement ", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 575;
	this.text.parent = this;
	this.text.setTransform(-287.7,-64.75);
...
p.nominalBounds = new cjs.Rectangle(-289.7,-66.7,579.4,133.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Maintain record on urinary output", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 574;
	this.text.parent = this;
	this.text.setTransform(-286.8,-61.45);
...
p.nominalBounds = new cjs.Rectangle(-288.8,-63.4,577.6,126.9);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Use incontinence pads if required, check regularly", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 612;
	this.text.parent = this;
	this.text.setTransform(-305.95,-66.75);
...
p.nominalBounds = new cjs.Rectangle(-307.9,-68.7,615.9,137.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Provide urinary catheter care", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 640;
	this.text.parent = this;
	this.text.setTransform(-320.1,-53.6);
...
p.nominalBounds = new cjs.Rectangle(-322.1,-55.6,644.3,111.2);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Consider need for urinary catheter if incontinence or retention are a concern", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 735;
	this.text.parent = this;
	this.text.setTransform(-367.35,-64.75);
...
p.nominalBounds = new cjs.Rectangle(-369.3,-66.7,738.7,133.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Consider artificial hydration as condition dictates", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 549;
	this.text.parent = this;
	this.text.setTransform(-274.5,-73.75);
...
p.nominalBounds = new cjs.Rectangle(-276.5,-75.7,553.1,151.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Observe for signs of aspiration such as coughing when taking drinks", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 547;
	this.text.parent = this;
	this.text.setTransform(-273.5,-64.75);
...
p.nominalBounds = new cjs.Rectangle(-275.5,-66.7,551.1,133.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Ensure appropriate pressure relieving aids are used", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 651;
	this.text.parent = this;
	this.text.setTransform(-325.25,-58.85);
...
p.nominalBounds = new cjs.Rectangle(-327.2,-60.8,654.5,121.69999999999999);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Monitor skin integrity, re-evaluate Waterlow assessment as needed", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
	this.text.lineWidth = 623;
	this.text.parent = this;
	this.text.setTransform(-311.25,-42.85);
...
p.nominalBounds = new cjs.Rectangle(-313.2,-44.8,626.5,89.69999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.text.lineWidth = 828;
	this.text.parent = this;
	this.text.setTransform(0,-70.25);
...
p.nominalBounds = new cjs.Rectangle(-415.9,-72.2,831.9,144.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Regular oral assessment and oral care", "bold 35px 'Leelawadee'");
	this.text.lineHeight = 44;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("•Providing eye care", "bold 35px 'Leelawadee'");
	this.text.textAlign = "center";
	this.text.lineHeight = 44;
...
(lib.BackButton5 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.text = new cjs.Text("BACK", "bold 39px 'Leelawadee'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 49;
	this.text.lineWidth = 125;
	this.text.parent = this;
	this.text.setTransform(-69.5,16.05);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("ArAEnIAApNIWBAAIAAJNg");
	this.shape.setTransform(-69.5,40.55);
...
p.nominalBounds = new cjs.Rectangle(-140,11.1,141,126.20000000000002);


(lib.BackButton4 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.BackButton3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
(lib.BackButton2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0,4,390,536,1417,1908,1909,1910,2040,2470,2574,5249,5696,6679,6680,7905];
	...
	this.frame_1417 = function() {
		...
		_this.BackButton1.on('click', function(){
		
		_this.gotoAndPlay(578);
		});
	}
	this.frame_1908 = function() {
		var _this = this;
		
		_this.BackButton2.on('click', function(){
		
		_this.gotoAndPlay(1419);
		});
	}
	...
	this.frame_2040 = function() {
		...
		_this.BackButton3.on('click', function(){
		
		_this.gotoAndPlay(1909);
		});
	}
	...
	this.frame_2574 = function() {
		...
		_this.BackButton4.on('click', function(){
	...
	this.frame_6680 = function() {
		var _this = this;
		
		_this.BackButton5.on('click', function(){
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(4).call(this.frame_4).wait(386).call(this.frame_390).wait(146).call(this.frame_536).wait(881).call(this.frame_1417).wait(491).call(this.frame_1908).wait(1).call(this.frame_1909).wait(1).call(this.frame_1910).wait(130).call(this.frame_2040).wait(430).call(this.frame_2470).wait(104).call(this.frame_2574).wait(2675).call(this.frame_5249).wait(447).call(this.frame_5696).wait(983).call(this.frame_6679).wait(1).call(this.frame_6680).wait(1225).call(this.frame_7905).wait(1));

	// BackButton1
	this.BackButton1 = new lib.BackButton();
	this.BackButton1.name = "BackButton1";
	this.BackButton1.setTransform(157.3,678.8);
	this.BackButton1._off = true;
	new cjs.ButtonHelper(this.BackButton1, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton1).wait(1417).to({_off:false},0).to({_off:true},491).wait(5998));

	// Backbutton2
	this.BackButton2 = new lib.BackButton2();
	this.BackButton2.name = "BackButton2";
	this.BackButton2.setTransform(157.3,678.8);
	this.BackButton2._off = true;
	new cjs.ButtonHelper(this.BackButton2, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton2).wait(1908).to({_off:false},0).to({_off:true},132).wait(5866));

	// BackButon3
	this.BackButton3 = new lib.BackButton3();
	this.BackButton3.name = "BackButton3";
	this.BackButton3.setTransform(157.3,678.8);
	this.BackButton3._off = true;
	new cjs.ButtonHelper(this.BackButton3, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton3).wait(2040).to({_off:false},0).to({_off:true},534).wait(5332));

	// BackButton4
	this.BackButton4 = new lib.BackButton4();
	this.BackButton4.name = "BackButton4";
	this.BackButton4.setTransform(157.3,678.8);
	this.BackButton4._off = true;
	new cjs.ButtonHelper(this.BackButton4, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton4).wait(2574).to({_off:false},0).to({_off:true},4106).wait(1226));

	// BackButton5
	this.BackButton5 = new lib.BackButton5();
	this.BackButton5.name = "BackButton5";
	this.BackButton5.setTransform(157.3,678.8);
	this.BackButton5._off = true;
	new cjs.ButtonHelper(this.BackButton5, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.BackButton5).wait(6680).to({_off:false},0).wait(1226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_43).wait(5279).to({_off:false},0).to({_off:true},14).wait(2613));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_111).wait(1401).to({_off:false},0).to({alpha:1},16).to({startPosition:0},4818).to({alpha:0},39).to({_off:true},1).wait(1631));
...
p.nominalBounds = new cjs.Rectangle(502.4,378,535.6,438.1);
// library properties:
lib.properties = {
